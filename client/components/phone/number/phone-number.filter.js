angular.module("managerApp").filter("phoneNumber", function () {
    "use strict";
    ...
    var numberPrefixSplitRegex = new RegExp("^00(" + euCodes.join("|") + ")(.*)$");
    ...
    function prettifyNumber (rawNumber) {
         ...
         */
        return rawNumber.replace(numberPrefixSplitRegex, function (number, prefix, rest) {
            var suffix = rest;
