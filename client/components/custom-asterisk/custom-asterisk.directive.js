 ...
 *  - in your translations add a html tag with class="custom-asterisk":
 *    <translation id="foo">I have an asterisk <span class="custom-asterisk"></span>
 ...
 *      </p>
 */
angular.module('managerApp').directive('customAsterisk', () => ({
  restrict: 'C',
  template: '*',
}));
