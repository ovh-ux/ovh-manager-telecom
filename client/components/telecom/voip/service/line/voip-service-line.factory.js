 ...
 *  <p>This factory doesn't describe any API return. The API that describes the most this factory is `/telephony/{billingAccount}/service/{serviceName}`.</p>
 *
 *  @constructor
 *  @param {Object} options Options required for creating a new instance of VoipServiceLine (see {@link managerApp.object:VoipService `VoipService` constructor} for availables options properties).
 */
