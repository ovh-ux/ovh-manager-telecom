 ...
 *  <p>This is the beginning of writing a documentation to help us to improve the OVH Telecom Control Panel.</p>
 *  <p>For the moment, only telephony (VoIP) section will be documented. It will show you how to use angular services to make the good calls to OVH API.</p>
 */
 ...
 *
 *  @description
 *  <p>This service is the beginning of everything :-) This service will allow you to fetch all billingAccounts and their services in one API call. It's used for example to display sidebar menu.</p>
 *  <p>This will be used to replace telecom/telephony factories and services like it has been done in a bad way :-)</p>
