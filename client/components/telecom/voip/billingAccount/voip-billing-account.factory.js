 ...
 *
 *  @description
 *  <p>Factory that describes a billingAccount with attributes returned by `/telephony/{billingAccount}` API.</p>
...
angular.module("managerApp").factory("VoipBillingAccount", function (VoipService, voipService) {
    ...
    class VoipBillingAccount {
        ...
        constructor (options = {}) {
             ...
             *  <p>You can populate this services list with `addService` method or with `addServices` method.</p>
             *
         ...
         *
         *  @description
         *  Add a service to billing account services list. If service already exists in list (meaning that a service with `serviceName` option is already in the list), the existing service will be replaced by a service with
        ...
        addService (service) {
            ...
            var serviceIndex = _.findIndex(this.services, {
         ...
         *
         *  @param {Array.<Object>|Object} services     An object or a list of objects with options for adding VoipService instances to billing account services list.
         *
         *  @return {Array.<VoipSercice>} The list of all the services of the billing account (including added services).
         */
