 ...
 *
 *  @description
 *  <p>Factory that describes a voip feature (e.g. sip, mgcp, contactCenterSolution, ...). This is a base for {@link managerApp.object:VoipLineFeature VoipLineFeature factory} and future VoipAliasFeature factory.</p>
 *  <p>Should not directly instanciated.</p>
 *
 *  @constructor
 *  @param {Object} options                 Shared (required) options for creating a new `VoipFeature` instance.
 ...
 *  @param {String} options.featureType     The type of the feature (sip, mgcp, contactCenterSolution, ...).
 */
