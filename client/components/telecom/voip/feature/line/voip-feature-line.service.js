 ...
 *
 *  @description
 *  <p>Service that manage features of services with serviceType line. This is not the line feature that is managed (the line service type either) !!!</p>
 *  <p>This service will manage API calls to `/telephony/{billingAccount}/line/{serviceName}` and `/telephony/{billingAccount}/fax/{serviceName}`</p>
 */
angular.module("managerApp").service("voipLineFeature", class {
     ...
     *
     *  @description
     *  Fetch feature from a service. Will let the good sub-service (`voipLine` or `voipFax`) managing the good API call.
     *
     ...
     *
     *  @description
     *  Save a feature by letting the good sub-service (`voipLine` or `voipFax`) managing the good API call.
     *
