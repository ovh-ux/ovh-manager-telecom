 ...
 *  <p>Factory that describes a line feature with attributes returned by `/telephony/{billingAccount}/line/{serviceName}` API.</p>
 *
 *  @constructor
 *  @param {Object} options Options required for creating a new instance of VoipLine (see {@link managerApp.object:VoipLineFeature `VoipLineFeature` constructor} for availables inherited options properties and
