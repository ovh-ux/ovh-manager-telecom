angular.module("managerApp").controller("TelecomTelephonyAliasConfigurationLiveCallsEavesdropCtrl", function ($uibModalInstance, $translate, Telephony, Toast, params) {
    "use strict";
