angular.module("managerApp").controller("TelecomTelephonyAliasConfigurationLiveCallsTransfertCtrl", function ($uibModalInstance, $translate, Telephony, Toast, params) {
    "use strict";
