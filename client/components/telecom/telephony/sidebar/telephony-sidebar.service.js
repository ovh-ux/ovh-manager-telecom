angular.module('managerApp').service('TelephonySidebar', function ($translate, SidebarMenu, telecomVoip, voipService) {
  ...
  self.initTelephonySubsection = function () {
    return telecomVoip.fetchAll().then((billingAccounts) => {
      ...
      const sortedBillingAccounts =
        billingAccounts.sort((first, second) =>
      ...
      sortedBillingAccounts.forEach((billingAccount) => {
        ...
        const sortedAlias =
          voipService.constructor.sortServicesByDisplayedName(billingAccount.getAlias());
        ...
        const sortedLines =
          voipService.constructor.sortServicesByDisplayedName(billingAccount.getLines());
