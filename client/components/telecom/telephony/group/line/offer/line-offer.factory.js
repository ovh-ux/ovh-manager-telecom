/**
 *  Need to have client/app/telecom/telephony/line translations files to be loaded for fullgetFullDescription method.
 *  This should be the case when a state like telecom.telephony.line.* is loaded.
 */
angular.module("managerApp").factory("TelephonyGroupLineOffer", function ($translate) {
    "use strict";

    var availableOfferTypes = ["priceplan", "individual", "trunk"];
    ...
    function TelephonyGroupLineOffer (offerOptionsParam) {
        var offerOptions = offerOptionsParam;
