angular.module("managerApp").factory("VoipTimeConditionCondition", function (voipTimeCondition, VOIP_TIMECONDITION_ORDERED_DAYS) {
    "use strict";
    ...
    VoipTimeConditionCondition.prototype.setOptions = function (conditionOptions) {
        ...
        if (self.featureType === "sip") {
            ...
            // because in v4 timeTo is something like this : 10:00:59. Format it to something like 09:59:59
    ...
    VoipTimeConditionCondition.prototype.clone = function () {
        var self = this;
        var timeConditionOptions = angular.copy(self);
    ...
    VoipTimeConditionCondition.prototype.getTimeMoment = function (time) {
        var self = this;
        var timePath = time ? "time" + _.capitalize(time) : "timeFrom";
        var splittedTime = _.get(self, timePath).split(":");
        return moment().day(VOIP_TIMECONDITION_ORDERED_DAYS.indexOf(self.weekDay) + 1).hour(splittedTime[0]).minute(splittedTime[1])
    ...
    VoipTimeConditionCondition.prototype.create = function () {
        ...
        return conditionResources.create(voipTimeCondition.getConditionResourceCallParams(self, null), voipTimeCondition.getConditionResourceCallActionParams(self)).$promise.then(function (conditionOptions) {
    ...
    VoipTimeConditionCondition.prototype.save = function () {
        ...
        return conditionResources.save(voipTimeCondition.getConditionResourceCallParams(self), voipTimeCondition.getConditionResourceCallActionParams(self)).$promise;
    };
    ...
    VoipTimeConditionCondition.prototype.remove = function () {
        ...
        return conditionResources.remove(voipTimeCondition.getConditionResourceCallParams(self)).$promise;
    };
    ...
    VoipTimeConditionCondition.prototype.stopEdition = function (cancel, cancelToOriginalSave, resetOriginalSave) {
        var self = this;
        var fromObject;
