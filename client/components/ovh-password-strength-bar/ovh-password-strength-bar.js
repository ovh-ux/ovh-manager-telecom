angular.module("ovhPasswordStrengthBar", []).directive("ovhPasswordStrengthBar", function () {
    "use strict";
    ...
    return {
        ...
        link: function ($scope) {
            ...
            $scope.$watch("pwd", function (newValue) {
