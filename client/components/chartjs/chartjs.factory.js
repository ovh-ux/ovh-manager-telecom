angular.module("managerApp").factory("ChartjsFactory", function (CHARTJS) {
    "use strict";

    var ChartjsFactory = function ChartjsFactory (data) {
    ...
    ChartjsFactory.prototype.setAxisOptions = function (axis, options, index) {
        if (_.isUndefined(index)) {
            this.options.scales[axis].forEach(function (data) {
