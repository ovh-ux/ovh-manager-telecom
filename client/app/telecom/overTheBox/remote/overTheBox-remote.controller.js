angular.module('managerApp').controller('OverTheBoxRemoteCtrl', function ($stateParams, $translate, $scope, $q, URLS, OVER_THE_BOX, OVERTHEBOX_REMOTE_STATUS, IpAddress, OvhApiOverTheBox, ToastError, Toast, tucValidator) {
  const self = this;
