angular.module('managerApp').controller('OverTheBoxDetailsCtrl', function ($scope, $rootScope, $filter, $translate, $q, $stateParams, XDSL, OVER_THE_BOX, OVERTHEBOX_DETAILS, OvhApiOverTheBox, OverTheBoxGraphService, TucToast, TucChartjsFactory) {
  const self = this;
