angular.module("managerApp").controller("PackxdslaccesslinediagnosticCtrl", function ($state, $stateParams, UserVipStatus) {
    "use strict";
    ...
    function init () {
        ...
        return UserVipStatus.Lexi().get().$promise.then(function () {
