angular.module('managerApp').controller('XdslModemPortsCtrl', function ($stateParams, $translate, $scope, OvhApiXdslModemPort, TucToast, PackXdslModemPortObject, validator, PackXdslModemMediator) {
  const self = this;
  self.loader = true;
