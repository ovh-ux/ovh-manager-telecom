angular.module('managerApp').controller('XdslModemDhcpCtrl', function ($stateParams, PackXdslModemDhcpObject, OvhApiXdsl, $q, $translate, Toast, tucValidator, TucPackXdslModemMediator) {
  const self = this;
