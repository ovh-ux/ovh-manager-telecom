angular.module('managerApp').controller('XdslModemLanCtrl', function ($stateParams, $translate, OvhApiXdsl, PackXdslModemLanObject, validator, $q, TucToast, PackXdslModemMediator) {
  const self = this;
