angular.module("managerApp")
    .controller("TelecomTelephonyBillingAccountPhonebookCtrl", function ($document, $filter, $q, $scope, $stateParams, $timeout, $translate, $uibModal, $window, Telephony, voipServiceTask, Toast, ToastError, TELEPHONY_PHONEBOOK) {
        "use strict";
    ...
    ===============================*/
        ...
        function fetchPhonebook () {
            return Telephony.Phonebook().Lexi().query({
                billingAccount: $stateParams.billingAccount
            }).$promise.then(function (phonebookIds) {
                if (_.size(phonebookIds)) {
                    return Telephony.Phonebook().Lexi().get({
                        billingAccount: $stateParams.billingAccount,
        ...
        function fetchPhonebookContact (bookKey) {
            return Telephony.Phonebook().PhonebookContact().Lexi().query({
                billingAccount: $stateParams.billingAccount,
                bookKey: bookKey
            }).$promise.then(function (phonebookContactIds) {
                return $q.all(_.map(_.chunk(phonebookContactIds, 50), function (chunkIds) {
                    return Telephony.Phonebook().PhonebookContact().Lexi().getBatch({
                        billingAccount: $stateParams.billingAccount,
                        bookKey: bookKey,
                        id: chunkIds
                    }).$promise;
    ...
    ===============================*/
        ...
        self.createPhonebook = function (form) {
            ...
            return Telephony.Phonebook().Lexi().create({
                billingAccount: $stateParams.billingAccount
        ...
        self.savePhonebook = function () {
            return Telephony.Phonebook().Lexi().update({
                billingAccount: $stateParams.billingAccount,
        ...
        self.exportPhonebookContact = function () {
            ...
            var tryGetCsvExport = function () {
                return Telephony.Phonebook().Lexi().getExport({
                    billingAccount: $stateParams.billingAccount,
        ...
        self.removePhonebookContact = function (contact) {
            ...
            return Telephony.Phonebook().PhonebookContact().Lexi().remove({
                billingAccount: $stateParams.billingAccount,
                bookKey: self.phonebook.bookKey,
                id: contact.id
            }).$promise.then(function () {
        ...
        self.refresh = function () {
            ...
            Telephony.Phonebook().PhonebookContact().Lexi().resetAllCache();
