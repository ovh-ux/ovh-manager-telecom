angular.module("managerApp").factory("TelecomTelephonyLineCallsForward", function ($translate) {
    "use strict";
    ...
    /**
         ...
         */
    var TelecomTelephonyLineCallsForward = function TelecomTelephonyLineCallsForward (options, key) {
        this.type = key;
        ...
        var number = options["forward" + key + "Number"];
    ...
    Object.defineProperty(TelecomTelephonyLineCallsForward.prototype, "saveData", {
        get: function () {
            ...
            var number = this.getCurrentNumber();
