angular.module("managerApp").controller("TelecomTelephonyLineClick2CallAddUserCtrl", function ($q, $stateParams, $state, $translate, $timeout, OvhApiTelephony, TelephonyMediator, TelephonyGroupLineClick2CallUser, Toast, telephonyBulk) {
    "use strict";
