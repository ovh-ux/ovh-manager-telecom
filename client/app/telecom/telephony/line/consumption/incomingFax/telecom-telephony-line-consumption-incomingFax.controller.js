angular.module("managerApp").controller("TelecomTelephonyLineConsumptionIncomingFaxCtrl", function ($stateParams, $q, $translate, $filter, $timeout, Telephony, ToastError) {
    "use strict";
