angular.module("managerApp").controller("TelecomTelephonyAliasConfigurationStatsEasyHuntingEavesdropCtrl", function ($scope, $uibModalInstance, $translate, Telephony, Toast, params) {
    "use strict";
