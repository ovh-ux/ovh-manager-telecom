angular.module("managerApp").controller("TelecomTelephonyServiceVoicemailDefaultCtrl", function ($scope, $stateParams, $q, $timeout, $filter, ToastError, OvhApiTelephony) {
    "use strict";
