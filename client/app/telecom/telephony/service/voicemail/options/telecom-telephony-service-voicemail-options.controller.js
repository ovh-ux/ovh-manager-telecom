angular.module('managerApp').controller('TelecomTelephonyServiceVoicemailOptionsCtrl',
  function ($stateParams, $q, $translate, $timeout, tucTelephonyBulk, TucToast, TucToastError,
    OvhApiTelephony, OvhApiMe) {
    const self = this;
    ...
    self.recordingChanged = function () {
      let isRemovedRecord = false;
      if (removeRecord) {
        isRemovedRecord = true;
      }
      ...
      || isUploadedFile || isRemovedRecord;
    };
    ...
    // display message of success or error
      tucTelephonyBulk.getTucToastInfos(bulkResult, {
        ...
        error: $translate.instant('telephony_line_answer_voicemail_options_update_bulk_error'),
      }).forEach((toastInfo) => {
    ...
    self.onBulkError = function (error) {
      TucToast.error([$translate.instant('telephony_line_answer_voicemail_options_update_bulk_on_error'), _.get(error, 'msg.data')].join(' '));
    };
