  ...
  grunt.initConfig({
    ...
    rev: {
      dist: {
        files: {
          src: [
            '<%= yeoman.dist %>/<%= yeoman.client %>/{,*/}*.js',
            '!<%= yeoman.dist %>/<%= yeoman.client %>/app/config.js',
            '<%= yeoman.dist %>/<%= yeoman.client %>/{,*/}*.css',
            '!<%= yeoman.dist %>/<%= yeoman.client %>/<%= yeoman.npm %>/chart.js',
          ]
        }
      }
    },
    ...
    usemin: {
      ...
      js: [
        '<%= yeoman.dist %>/<%= yeoman.client %>/{,*/}*.js', '!<%= yeoman.dist %>/<%= yeoman.client %>/<%= yeoman.npm %>/chart.js'
      ],
      options: {
        assetsDirs: [
    ...
    copy: {
      dist: {
        files: [{
          ...
          expand: true,
          cwd: '<%= yeoman.client %>',
          dest: '<%= yeoman.dist %>/<%= yeoman.client %>/<%= yeoman.npm %>',
          src: [
            '../<%= yeoman.npm %>/**/*.{ttf,woff,woff2,svg,eot,otf}',
            '../<%= yeoman.npm %>/bootstrap/dist/css/bootstrap.min.css',
            '../<%= yeoman.npm %>/angular-i18n/*.js'
          ]
        }, {
          expand: true,
      ...
      ngdocs: {
        files: [{
          expand: true,
          dot: true,
          cwd: '<%= yeoman.npm %>/ovh-ui-kit-bs/dist/',
          dest: 'docs/css',
          src: [
            '**/*'
          ]
    ...
    //#######################################################################################
    //##    TASK: injector                                                                 ##
    //##      Inject script files into index.html                                          ##
    //##      Inject css files into index.html                                             ##
    //##      Inject less files in app.less                                                ##
    //##      Inject node modules less into index.html in specific tags                    ##
    //##      Inject node modules scripts into index.html in specific tags                 ##
    //#######################################################################################
    injector: {
      options: {},
    ...
    ngdocs: {
      ...
      voip: {
        src: ['<%= yeoman.client %>/components/telecom/voip/**/*.js'],
        title: 'Telephony API',
        api: true
      }
    }
